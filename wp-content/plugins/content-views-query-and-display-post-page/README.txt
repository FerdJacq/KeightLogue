...
Add the created view shortcode to the Classic editor, page builder, widget, or anywhere you want to display your posts.
...
Our blocks and shortcode have both normal and AJAX pagination. AJAX pagination will retrieve posts without reloading the page, using 3 different pagination styles including numeric pagination, load more, and infinite scroll.
...
* **Advanced Custom Fields, Meta Box, Pods**: filter posts by custom fields, and show custom field for each post in the grid
...
* **Yoast SEO, Rank Math**: filter posts by primary category, and show only primary category in meta output of each post
...
* Change the html tag, length of post title
...
* Display advertisements between posts in the grid
...
Create a new page and click the '+' sign, search for Content Views, or scroll to the CONTENT VIEWS section, you will find all our 15+ creative Gutenberg blocks there. Click on the block you want to insert in your page and start displaying your posts stunningly with our blocks.
